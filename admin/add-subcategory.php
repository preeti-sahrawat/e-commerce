...
$query=mysqli_query($con,"insert into product_subcategory(category_id,subcategory_name,product_subcat_desc) values('$categoryid','$subcatname','$subcatdescription')");
if($query)
{
...
{    
?>
<option value="<?php echo htmlentities($result['id']);?>"><?php echo htmlentities($result['product_cat_name']);?></option>
<?php } ?>
